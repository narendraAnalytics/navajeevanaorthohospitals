...
export const specialties: Specialty[] = [
  ...
  },
  {
    ...
    accentColor: '#C06030',
    intro: 'Hip Replacement Surgery, or Total Hip Arthroplasty (THA), is one of the most successful orthopedic procedures performed worldwide. It involves replacing the damaged hip joint with a precisely engineered prosthetic implant to eliminate pain, restore mobility, and improve overall quality of life. Modern minimally invasive techniques result in faster recovery, less blood loss, and smaller incisions compared to traditional approaches.',
    whenRecommended: [
      'Chronic hip pain that limits daily activities',
      'Persistent pain even while resting or sleeping',
      'Stiffness that makes it difficult to bend or lift the leg',
      'Inadequate pain relief from medications or injections',
      'Significant hip joint damage visible on imaging',
      'Difficulty performing routine tasks due to hip pain',
    ],
    conditionsTreated: [
      'Osteoarthritis',
      'Rheumatoid Arthritis',
    ...
    types: [
      {
        ...
        desc: 'Both the femoral head and acetabular socket are replaced with prosthetic components, providing complete pain relief.',
      },
      {
        title: 'Hip Resurfacing',
        desc: 'The damaged surface of the femoral head is replaced with a metal cap while preserving more bone. Ideal for younger, active patients.',
      },
    ],
    benefits: [
      ...
      'Better sleep quality due to pain relief',
      'Long-term durability — implants typically last 15–25 years',
    ],
    recovery: [
      'Patients typically stand and take first steps within 24 hours of surgery',
      'Hospital stay is usually 3 to 5 days',
      'Walking aids (walker or crutches) used for 4–6 weeks',
      'Most patients resume daily activities within 6 weeks',
      'Full recovery and return to active lifestyle within 3–6 months',
    ],
    risks: [
      'Blood clots (DVT)',
    ...
    faqs: [
      { q: 'How long does a hip replacement last?', a: 'Modern hip implants typically last 15–25 years with proper care and activity modifications.' },
      { q: 'When can I drive after hip replacement?', a: 'Most patients can drive 4–6 weeks after surgery, once they are off pain medications and have adequate strength and reflexes.' },
      { q: 'Can I climb stairs after hip replacement?', a: 'Yes. Most patients can climb stairs within a few weeks, using a handrail for support initially.' },
      { q: 'Will I set off metal detectors?', a: 'Yes, hip implants can trigger metal detectors. You will receive a medical card confirming your implant.' },
    ],
  },
  {
    slug: 'spine-surgery',
